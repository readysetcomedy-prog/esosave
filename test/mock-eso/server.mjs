...
export function createMockEso() {
  ...
  const FIELD_CONFIGS = {
    ...
    'incident.response.unitCapabilityID': F('UNITCAPABILITYID', 'singleselect', 'Unit Capability', 'SL.RESPONSEPRIORITY'), // ESO sets it from the unit; never offered
    ...
    'narrative.narrativeTimes.lastKnownWell': F('LASTKNOWNWELL', 'datetime', 'Last Known Well'),
    'narrative.narrativeTimes.lastKnownWellPertinentNegativeID': F('LASTKNOWNWELLPERTINENTNEGATIVEID', 'pertinentNegative', 'UTO', 'SL.PERTINENTNEGATIVEFORTIMES'),
