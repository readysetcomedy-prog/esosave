...
- **Quick buttons.** One-tap chips for the common history items, home medications and allergies sit
  ...
  presses ESO's own None button on every delay still empty, leaving any already answered alone. Red, yellow and green buttons next to Initial and Final Patient Acuity pick the
